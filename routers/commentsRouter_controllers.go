...
func init() {
    ...
    beego.GlobalControllerRouter["quatrains-go/controllers:ObjectController"] = append(beego.GlobalControllerRouter["quatrains-go/controllers:ObjectController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
    ...
    beego.GlobalControllerRouter["quatrains-go/controllers:UserController"] = append(beego.GlobalControllerRouter["quatrains-go/controllers:UserController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
